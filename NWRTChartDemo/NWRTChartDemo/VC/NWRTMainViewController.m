...
-(void)__setupUI{
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(10, 60, 100, 30)];
    label.text = @"柱状图Demo";
    [self.view addSubview:label];
    
    UILabel *desc = [[UILabel alloc] initWithFrame:CGRectMake(10, 420, 300, 60)];
    desc.font = [UIFont systemFontOfSize:12];
    desc.textColor = [UIColor redColor];
    desc.numberOfLines = 3;
    desc.text = @"1.点击Add添加柱子,最多可添加5个\n2.点击Clear清空柱状图\n3.点击对应的柱子一次高度加1";
